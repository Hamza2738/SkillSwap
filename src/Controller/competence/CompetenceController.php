...
public function edit(
    ...
    public function exportPdf(): Response
    {
        ...
        $logoPath = $this->getParameter('kernel.project_dir') . '/public/images/competences/logo.png';
        $logoBase64 = file_exists($logoPath)
            ? 'data:image/png;base64,' . base64_encode(file_get_contents($logoPath))
            : '';

        $signaturePath = $this->getParameter('kernel.project_dir') . '/public/images/competences/signature.png';
