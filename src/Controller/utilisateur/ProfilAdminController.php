...
public function update(Request $request, EntityManagerInterface $em): Response
{
    ...
    $admin->setNom(trim((string) $request->request->get('nom', $admin->getNom())));
    $admin->setPrenom(trim((string) $request->request->get('prenom', $admin->getPrenom())));
    $admin->setTelephone(trim((string) $request->request->get('telephone', $admin->getTelephone())));
    $admin->setBio(trim((string) $request->request->get('bio', $admin->getBio())));
    $admin->setLieu(trim((string) $request->request->get('lieu', $admin->getLieu())));
